...
def make_prefix(dp, template_type):
    ...
    if template_type == 'base':
        ...
        prefix = f"""Given the question, think about what kind of search query might help retrieve the answer. \
Output your reasoning inside <think> and </think>, followed by the final query wrapped in <search> and </search>. \
Question: {question}\n"""
    else:
