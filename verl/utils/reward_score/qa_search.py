...
def compute_score_em(solution_str, ground_truth, method='strict', format_score=0., score=1., log_recall=True, recall_log_path='./recall_result/nqhotpot_after_train.json', return_details=False):
    ...
    combined_score = score if recalled else format_score
    ...
    if return_details:
        return {
            'recall_score': combined_score,  # In qa_search, recall is the main metric
