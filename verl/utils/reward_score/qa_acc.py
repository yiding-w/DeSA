...
def compute_score_em(solution_str, ground_truth, method='strict', format_score=0., score=1., 
                    log_recall=False, recall_log_path='./recall_result/qa_acc_results.json', 
    ...
    # Compute retrieval accuracy (main component)
    ...
    combined_score = retrieval_accuracy * score
    # if combined_score == 0:
    ...
    if do_print:
        ...
        print(f"[QA_ACCANDEM] Combined score: {combined_score:.3f} (1*{retrieval_accuracy:.3f}")
    ...
    if return_details:
        return {
            'recall_score': retrieval_accuracy,  # Use retrieval accuracy as recall score
