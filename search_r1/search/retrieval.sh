...
save_dir=/path/to/your/dataset/e5/$DATA_NAME/$TOPK
# INDEX_PATH=/path/to/your/corpus/index/wiki-21
# CORPUS_PATH=/path/to/your/corpus/corpora/wiki/enwiki-dec2021/text-list-100-sec.jsonl
